...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    if (!canvasEl) return;
    // After null check, canvas is guaranteed non-null for all closures
    ...
    // @ts-expect-error - constructor function pattern
    ...
    function getWebGLContext(cvs: HTMLCanvasElement) {
      ...
      let glCtx = cvs.getContext('webgl2', params) as WebGL2RenderingContext | null;
      const isWebGL2 = !!glCtx;
      if (!isWebGL2) glCtx = (cvs.getContext('webgl', params) || cvs.getContext('experimental-webgl', params)) as WebGL2RenderingContext;
    ...
    function supportRenderTextureFormat(glCtx: WebGL2RenderingContext, internalFormat: number, format: number, type: number) {
